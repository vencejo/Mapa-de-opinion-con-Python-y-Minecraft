...
class Minecraft:
    ...
    def getBlocks(self, *args):
        ...
        blocksInString = self.conn.sendReceive("world.getBlocks", intFloor(args))
        listStringBlocks = blocksInString.split(',')
	listOfBlocks = [int(block) for block in listStringBlocks]
        return listOfBlocks
